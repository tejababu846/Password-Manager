...
class PasswordManager extends Component {
  ...
  componentDidMount() {
    const savedPasswords = localStorage.getItem('passwordManagerList');
    if (savedPasswords) {
      this.setState({ passwordManagerList: JSON.parse(savedPasswords) });
    }
  }

  componentDidUpdate(prevProps, prevState) {
    if (prevState.passwordManagerList !== this.state.passwordManagerList) {
      localStorage.setItem(
        'passwordManagerList',
        JSON.stringify(this.state.passwordManagerList)
      );
    }
  }
